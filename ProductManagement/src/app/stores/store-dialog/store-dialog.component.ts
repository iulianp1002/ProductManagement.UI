  ...
  constructor (private http: HttpClient, 
    ...
    ngOnInit(): void {
      ...
      if(this.editStoreData){
        console.log('edit form:',this.editStoreData)
     ...
     addStore(){
      if(!this.editStoreData){ 
        if(this.storeForm.valid){ console.log('ading',this.storeForm.value)
        ...
        storeFormated.detalii = this.storeForm.value.dataInregistrare;
